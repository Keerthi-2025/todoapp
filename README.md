A simple **To-Do List Web Application** built using **Spring Boot** and **HTML (Thymeleaf)**. This application allows users to create, update, and delete tasks in a clean and minimal interface.
